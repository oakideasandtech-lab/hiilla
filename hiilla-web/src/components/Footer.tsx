...
import { SOCIAL_LINKS, FOOTER_LEGAL, ADDRESS } from '@/lib/constants';
    ...
    <footer className={styles.footer}>
      <div className={styles.inner}>
        ...
        <div className={styles.location}>
          <a href={ADDRESS.mapsUrl} target="_blank" rel="noopener noreferrer" aria-label="View on Google Maps">
